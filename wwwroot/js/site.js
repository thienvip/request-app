...
$(function () {
    ...
    $("input:text[data-val-required],input[type = text],input:radio[data-val-required],input:password[data-val-required],select[data-val-required],textarea[data-val-required]").each(function () {
    ...
    var showAlert = function (alert) {
        swal("", alert.message, alert.alertClass);

    };
    window.alerts = {
        showAlert: showAlert,
        success: function (message) { showAlert({ alertClass: "success", message: message }); },
        info: function (message) { showAlert({ alertClass: "info", message: message }); },
        warning: function (message) { showAlert({ alertClass: "warning", message: message }); },
        error: function (message) { showAlert({ alertClass: "danger", message: message }); }
    };
...
function ShowLoadingMessage() {
    $('body').loading({
        message: 'Loading.Please wait a few moment...'
      });
}
