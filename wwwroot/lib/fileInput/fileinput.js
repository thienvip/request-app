...
(function (factory) {
    ...
    var $h, FileInput, getLoadingUrl = function () {
        ...
        return srcPath.substring(0, srcPath.lastIndexOf("/") + 1) + 'fileInput/img/loading.gif'
    };
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    downloadIcon: '<i class="glyphicon glyphicon-cloud-download"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="glyphicon-chevron-left"></i>',
            next: '<i class="glyphicon-chevron-right"></i>',
