 ...
 */ !(function (e) {
  ...
  var t,
    ...
    a = function () {
      ...
      return t.substring(0, t.lastIndexOf("/") + 1) + "fileInput/img/loading.gif";
    };
  (t = {
          ...
          (a = function (w) {
            ...
            if ($) {
              ...
              if (
                ...
                var q = { id: U, index: w, fileId: E, file: $, files: i };
                return (
